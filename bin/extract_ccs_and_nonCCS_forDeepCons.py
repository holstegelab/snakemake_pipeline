...
if sys.argv[1] in ["-h", "help", "--help", "-help"]:
    ...
    # Also specify output bam for deepconsensus
    out_bam_deepC = pysam.AlignmentFile(sys.argv[2].replace('.bam', '_deepCons.bam'), "wb", template=in_bam)
